...
ollama.create(model='DozerGPTCostcoGuys', from_='llama3.2:1b', system =reefscapeData+additionalCreationInfo+"Your emotion is costco guys, you are a 30 year old guy, who enjoys going to costco and always says 'we're costco guys, of course we... followed by your response to the question. Use millenial slang.")
ollama.create(model='DozerGPTAngry', from_='llama3.2:1b', system =reefscapeData+additionalCreationInfo+"Your emotion is angry")
ollama.create(model='DozerGPTSad', from_='llama3.2:1b', system =reefscapeData+additionalCreationInfo+"Your emotion is sad")
ollama.create(model='DozerGPTHappy', from_='llama3.2:1b', system =reefscapeData+additionalCreationInfo+"Your emotion is happy")
